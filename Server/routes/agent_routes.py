...
async def chat_with_bot_route(user_dto: UserObject,  user_message: str, redis:ChatMemoryDep):
    return await chat_with_bot(user_dto=user_dto ,user_message=user_message, redis=redis)